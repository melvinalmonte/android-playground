package com.example.weightcalcapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setLogo(R.mipmap.codeicon);
        ...
        handleSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    displayData.setText("Invalid Operation. No Selection Made. Please Enter Weight and Select a Conversion.");
                }
            }
        });
